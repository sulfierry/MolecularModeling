...
4. 
   $$\phi = \arctan2\left( \frac{\vec{r}_{ji} \times \vec{r}_{jk} \cdot \vec{r}_{kl}}{\left|\vec{r}_{ji} \times \vec{r}_{jk}\right| \left|\vec{r}_{jk} \times \vec{r}_{kl}\right|}, \frac{\left(\vec{r}_{ji} \times \vec{r}_{jk}\right) \cdot \left(\vec{r}_{jk} \times \vec{r}_{kl}\right)}{\left|\vec{r}_{ji} \times \vec{r}_{jk}\right| \left|\vec{r}_{jk} \times \vec{r}_{kl}\right|} \right)$$
