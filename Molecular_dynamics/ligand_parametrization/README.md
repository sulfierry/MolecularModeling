...
2. **Adjustment of Charges values**: 
...
3. **Empirical charge distribution among hydrogen atoms**: 
...
4. **Generation of additional force field parameters (.frcmod File)**: 
...
5. **Preparation of ligand library and complex for simulation**: 
   - Commands: 
     - `source leaprc.gaff`
